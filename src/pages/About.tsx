...
import { Brain, CheckCircle, Trophy, Target, Rocket } from "phosphor-react";
    ...
    <div className="min-h-screen pt-16">
      ...
      <section className="relative py-20 sm:py-32 bg-white overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-lg sm:text-xl md:text-2xl text-sailcraft-dark max-w-4xl mx-auto leading-relaxed">
            Engineering growth for East Africa's most ambitious SMEs
          </p>
        </div>
      </section>
